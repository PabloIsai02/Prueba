        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-sm-6 text-center">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addSupplierModal">
                    <i class="material-icons">&#xE147;</i> <span>Agregar Nuevo Proveedor</span>
                </button>
            </div>
        </div>
            ...
            <div class="table-wrapper">
                <table class="table table-striped table-hover">
                    ...
                    @foreach($suppliers as $supplier)
                        ...
                        <div class="modal" id="editSupplierModal{{ $supplier->id }}">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('admin.suppliers.update', ['id' => $supplier->id]) }}"
                                              method="POST">
                                            @csrf
                                            @method('PUT')
                                            <!-- Agrega un campo oculto para el ID -->
                                            <input type="hidden" name="id" value="{{ $supplier->id }}">
                                            <!-- Campos para el nombre, correo y teléfono del proveedor -->
